# Documentação para Dev — Audience Builder
...
- **Domínio oficial:** audience.fbr.news
- **Domínio de validação:** https://audience.fbr.news/health
- **Namespace:** `fbr/custom/153d40a6-5823-4029-add3-b52604cd3b71`
- **Target:** `vps2`
- **Repository path:** `/09-codigo`
- **Easypanel project:** `sistemas`
- **Easypanel service:** `audience`
...
CONTROL_TOWER_SCHEMA_NAME=custom_audience
...
SUPABASE_ANON_KEY=<secret-manager:fbr/custom/153d40a6-5823-4029-add3-b52604cd3b71/SUPABASE_ANON_KEY>
...
- Operar exclusivamente no schema `custom_audience`.
...
- [ ] https://audience.fbr.news/health retorna HTTP 200.
